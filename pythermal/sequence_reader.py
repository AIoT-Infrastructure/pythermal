#!/usr/bin/env python3
"""
Thermal Sequence Reader and Unified Capture Interface

Provides a VideoCapture-like interface for reading pre-recorded thermal camera sequences
and live thermal camera feeds. Compatible with the ThermalSharedMemory interface for
